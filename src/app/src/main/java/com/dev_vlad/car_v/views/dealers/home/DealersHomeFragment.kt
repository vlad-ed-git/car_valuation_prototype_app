...
class DealersHomeFragment: Fragment(), MyCarsAdapter.MyCarsActionsListener {
    ...
    private val dealersHomeViewModel: DealersHomeViewModel by viewModels {
        ...
        DealersHomeViewModelFactory(carVApp.userRepo, carVApp.carRepo)
    }
    private val carsAdapter = MyCarsAdapter(this)
