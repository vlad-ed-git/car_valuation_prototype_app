...
class SentOffersFragment : Fragment(), SentOffersAdapter.SentOffersActionsListener {
    ...
    private fun observeSentOffers() {
        sentOffersViewModel.observeSentOffers().observe(
            ...
            sentOffersViewModel.isLoading = false
            if (it == null) {
                MyLogger.logThis(
                        TAG,
                        "observeSentOffers()",
            ...
            sentOffersRv.apply {
                ...
                this.addOnScrollListener(object : RecyclerView.OnScrollListener() {
                    override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                        ...
                        if (!sentOffersRv.canScrollVertically(1)) {
                            //we have reached the bottom of the list
                            sentOffersViewModel.fetchMoreCars(totalItemsInListNow = sentOffersAdapter.itemCount)
                        }
                    }
                })
